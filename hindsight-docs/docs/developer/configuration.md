...
| `HINDSIGHT_API_TIMEZONE` | IANA timezone used for relative-date interpretation, LLM date/time prompts, and Control Plane date display. Naive input timestamps are interpreted in this timezone and stored as UTC. | `UTC` |
